...
def countX(strr):
  if(strr == "x" and len(strr)==1):
    return 1
  elif(strr != "x" and len(strr)==1 or len(strr)==0):
    return 0
  else:
    if(strr[-1]=="x"):
      return 1+countX(strr[:-1])
    else:
      return countX(strr[:-1])


# Given a string, compute recursively (no loops) the number of times 
# lowercase "hi" appears in the string.
def countHi(strr):
  if(strr=="hi" and len(strr)==2):
    return 1
  elif(strr!="hi" and len(strr)==2 or len(strr)<2):
    return 0
  else:
    if(strr[-2:]=="hi"):
      return 1+countHi(strr[:-2])
    else:
      return countHi(strr[:-1])
...
def changeXY(strr):
  if(len(strr)==0):
    return ""
  elif(strr=="x" and len(strr)==1):
    return "y"
  elif(strr!="x" and len(strr)==1):
    return strr
  else:
    if(strr[-1]=="x"):
      return changeXY(strr[:-1])+"y"
    else:
      return changeXY(strr[:-1])+strr[-1:]
...
def changePi(strr):
  if(len(strr)==0):
    return ""
  elif(strr=="pi" and len(strr)==2):
    return "3.14"
  elif(strr!="pi" and len(strr)<=2):
    return strr
  else:
    if(strr[-2:]=="pi"):
      return changePi(strr[:-2]) +"3.14"
    else:
      return changePi(strr[:-1])+strr[-1:]


# Given a string, compute recursively a new string where all the 'x' 
# chars have been removed.
def noX(strr):
  if(len(strr)==0 or strr=="x"):
    return ""
  elif(strr!="x" and len(strr)==1):
    return strr
  else:
...
def array220(nums, index):
  if(len(nums)==index):
    return False
  elif(nums[index]*10 in nums[index:]):
    return True
  else:
...
def endX(strr):
  if(len(strr)==0):
    ...
    return endX(strr[1:])+"x"
  else:
    return strr[0]+endX(strr[1:])
...
def countPairs(strr):
  if(len(strr)<3):
    ...
    return 1+countPairs(strr[:-1])
  else:
    return countPairs(strr[:-1])
...
def countAbc(strr):
  if(len(strr)<3 or "abc" not in strr and "aba" not in strr):
    return 0
  elif(strr[0:3]=="abc" or strr[0:3]=="aba"):
    return 1+countAbc(strr[2:])
  else:
    return countAbc(strr[1:])
...
def count11(strr):
  if(len(strr)<2 or "11" not in strr):
    return 0
  elif(strr[0:2]=="11"):
    return count11(strr[2:])+1
  else:
    return count11(strr[1:])


# Given a string, return recursively a "cleaned" string where adjacent 
# chars that are the same have been reduced to a single char. So "yyzzza" 
# yields "yza".
def stringClean(strr):
  if(len(strr)==0):
    return ""
  elif(len(strr)<2):
    return strr
  elif(strr[0]==strr[1]):
    return stringClean(strr[1:])
  else:
    return strr[0]+stringClean(strr[1:])
...
def countHi2(strr):
  if(len(strr)<2):
    return 0 
  elif(strr[0]=="x" and strr[1]!="x"):
    return countHi2(strr[2:])
  else:
    return countHi2(strr[1:])+int(strr[0:2]=="hi")
...
def parenBit(strr):
  if(len(strr)<2 or strr[0]=="(" and strr[-1]==")"):
    return strr
  elif(strr[0]!="("):
    return parenBit(strr[1:])
  else:
    return parenBit(strr[:-1])
...
def nestParen(strr):
  if(len(strr)==0):
    ...
    return False
  elif(strr[0]=="(" and strr[-1]==")" and len(strr)==2):
    return True
  elif(strr[0]=="(" and strr[-1]==")" and len(strr)>2):
    return nestParen(strr[1:-1])
  else:
    return False
...
def strCount(strr, sub):
  if(len(strr)==0):
    return 0
  elif(sub==strr[0:len(sub)]):
    return 1+strCount(strr[len(sub):], sub)
  else:
    return strCount(strr[1:], sub)
...
def strCopies(strr, sub, n):
  if(n==0):
    return True
  elif(len(strr)==0):
    return False
  elif(n!=0 and len(strr)!=0 and sub==strr[0:len(sub)]):
    return strCopies(strr[1:], sub, n-1)
  else:
    return strCopies(strr[1:], sub, n)


# Given a string and a non-empty substring sub, compute recursively the 
# largest substring which starts and ends with sub and return its length.
def strDist(strr, sub):
